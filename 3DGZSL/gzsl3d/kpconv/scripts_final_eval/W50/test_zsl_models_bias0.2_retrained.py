...
if __name__ == '__main__':
    ...
    parser.add_argument('--chosen_chkp', type=str, help="Model path")
    parser.add_argument('--chosen_u_chkp', type=str, help="Uncertainty estimator path")
    ...
    chkp_idx = None
    chosen_chkp = args_file.chosen_chkp
    chosen_u_chkp = args_file.chosen_u_chkp
    bias = 0.2
    weight = 50
    generative = True
    ...
    if config.dataset == 'ModelNet40':
        ...
        config.path = args_file.data_path
    ...
    tester = ModelTester(net, chkp_path=chosen_chkp, u_chkp_path=chosen_u_chkp, generative=generative)
    print('Done in {:.1f}s\n'.format(time.time() - t1))
